...
export async function fetchStoriesForFace(token: string, faceId: number): Promise<StoryListItem[]> {
...
export async function fetchMyStories(token: string, faceId?: number): Promise<StoryMineRow[]> {
